...
---
This document will assist in making PCoA plots, NMDS plots, heatmaps and alpha beta diversity plots using PhyloSeq and other R packages.
...
plots <- lapply(seq_len(nrow(plot_specs)), function(i) {
  ...
  # Save the plot
  ggsave(
    filename = paste0("Mcap2020/Figures/16S/relabund_", tolower(r), "_rare.png"),
    plot = p,
    height = h,
    width = 18
  )
...
pdf(file = "Mcap2020/Figures/16S/16S-Phylum-Heatmap-YOURS.pdf", height = 8, width = 8)
...
ggsave(
  plot = pcoa_viz,
  filename = "Mcap2020/Figures/16S/pcoa_16S.jpeg",
  height = 6,
  width = 8
)
...
ggsave(plot = pcoa_viz.nmds, filename = "Mcap2020/Figures/16S/nmds_16S.jpeg", height = 6, width = 8)
ggsave(plot = pcoa_viz.nmds, filename = "Mcap2020/Figures/16S/nmds_16S.pdf", height = 6, width = 8)
