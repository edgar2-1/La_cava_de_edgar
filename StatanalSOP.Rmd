...
plots <- lapply(seq_len(nrow(plot_specs)), function(i) {
  ...
  # Save the plot
  ggsave(
    filename = paste0("filename/Figures/16S/relabund_", tolower(r), "_rare.png"),
    plot = p,
    height = h,
    width = 18
  )
...
pdf(file = "filename/Figures/16S/16S-Phylum-Heatmap-YOURS.pdf", height = 8, width = 8)
...
# Save to PDF
pdf(file = "filename/Figures/16S/16S-Family-Heatmap.pdf", height = 10, width = 10)
...
ggsave(
  plot = pcoa_viz,
  filename = "filename/Figures/16S/pcoa_16S.jpeg",
  height = 6,
  width = 8
)
...
ggsave(plot = pcoa_viz.nmds, filename = "filename/Figures/16S/nmds_16S.jpeg", height = 6, width = 8)
ggsave(plot = pcoa_viz.nmds, filename = "filename/Figures/16S/nmds_16S.pdf", height = 6, width = 8)
...
pdf(file = "filename/Figures/16S/16S-ComplexHeatmap.pdf", height = 10, width = 18)
...
# Save as PNG and PDF
ggsave(plot = alpha1_plot, file = "filename/Figures/16S/alpha_rare.png", width = 4, height = 7)
ggsave(plot = alpha1_plot, file = "filename/Figures/16S/alpha_rare.pdf", width = 4, height = 7)
```
